      ...
      >
        ...
        <div className="Patient-Details p-2.5 flex flex-col gap-4">
          ...
          <div className="Extra-Info flex items-center gap-3">
            <img
              src="/assets/Patient-Infomation-Icon/BirthIcon.svg"
          ...
          <div className="Extra-Info flex items-center gap-3">
            <img
              src="/assets/Patient-Infomation-Icon/FemaleIcon.svg"
              className="w-12 h-12 p-2"
              alt="Gender Icon"
            />
            <div className="text-[14px] flex flex-col items-start">
          ...
          <div className="Extra-Info flex items-center gap-3">
            <img
              src="/assets/Patient-Infomation-Icon/PhoneIcon.svg"
              className="w-12 h-12 p-2"
              alt="Phone Icon"
            />
            <div className="text-[14px] flex flex-col items-start">
          ...
          <div className="Extra-Info flex items-center gap-3">
            <img
              src="/assets/Patient-Infomation-Icon/InsuranceIcon.svg"
              className="w-12 h-12 p-2"
              alt="Insurance Icon"
            />
            <div className="text-[14px] flex flex-col items-start">
